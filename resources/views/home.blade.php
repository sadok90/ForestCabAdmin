...
@section('page_heading','ForestCab')
@section('section')
                        ...
                        <div class="panel-heading">
                            <div class="row"> 
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div>{{trans('forestCab.Messages')}}</div> 
                                </div>
                            </div>
                        </div>
                        <a href="/messages">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">{{$carsCount}}</div>
                                    <div>{{trans('forestCab.Cars')}}</div>
                                </div>
                            </div>
                        </div>
                        <a href="/cars">
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">{{$reservationsCount}}</div>
                                    <div>{{trans('forestCab.Reservations')}}</div>
                                </div>
                            </div>
                        </div>
                        <a href="/reservation">
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">{{$driversCount}}</div>
                                    <div>{{trans('forestCab.Drivers')}}</div>
                                </div>
                            </div>
                        </div>
                        <a href="/drivers">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">{{$promosCount}}</div>
                                    <div>{{trans('forestCab.Promos')}}</div>
                                </div>
                            </div>
                        </div>
                        <a href="/promos">
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">{{$optionsCount}}</div>
                                    <div>{{trans('forestCab.Options')}}</div>
                                </div>
                            </div>
                        </div>
                        <a href="/options">
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">{{$rangesCount}}</div>
                                    <div>{{trans('forestCab.Ranges')}}</div>
                                </div>
                            </div>
                        </div>
                        <a href="/ranges">
